...
export const SplashPage = () => {
  return (
    <View className="flex-1 bg-white items-center justify-center px-5 md:px-10 lg:px-20">
      <View className="w-full max-w-[600px]">
        <View className="items-center mb-[200px]">
          <Text className="text-[48px] md:text-[64px] lg:text-[72px] leading-tight tracking-normal font-extrabold text-text-100 text-center font-sans mt-[130px]">
            문구로고{"\n"}뭐그런거
          </Text>
